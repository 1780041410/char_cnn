...
for i in range(REPEAT):
    ...
    for dup, q1, q2 in zip(df_train["label"], df_train["question1"], df_train["question2"]):
        if dup:
...
submission = pd.DataFrame({"test_id":df_test["id"], "label":test_label})
